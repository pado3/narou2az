...
【2025/10/16】 update: まれな見出し表示乱れを修正(narou2az.py, narou2az_d.py)<br />
青空文庫形式でまれに生じていた「見出し」の表示乱れを修正しました。具体的には、節タイトルに角括弧[〜]や［〜］を含む作品があり、これが青空文庫形式で見出しを表す注記と干渉することで、見出しが正しく表示されませんでした。<br />
一例： https://ncode.syosetu.com/n9941fv/5/ <br />
そのため、青空文庫形式の場合に亀甲括弧〔〕へ置換します。

【2025/11/04】 update: 潜在的なエピソード順序のバグを修正(narou2az.py, narou2az_d.py)<br />
os.listdir()がエピソード順通りに並ぶとは限らないことにcopilotの指摘で気付いて修正しました。その他、細かな見直しをしています。
